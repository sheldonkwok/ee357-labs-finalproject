...
Final_result: // Finalize and format the result into D2 or D3
		MOVE.L	signnew, D3		// load sign of output	
		LSL.L	#8,D3			// shift left
		LSL.L	#3,D3			// shift left
		MOVE.L	D3,	output
		
		MOVE.L 	expnew,D3
		ADDI.L	#15,D3			// excess 15
		LSL.L	#6,D3			// shift to exponent
		ADD.L	D3, output		
				
		MOVE.L	fracnew, D3	
		ADD.L	D3, output		// just add to output
...
BLINK: 	move.l d2,d8
		lsr.l #8,d8
		andi.l #0x0f,d8		// Clear 1st # except for 4 LSB
		move.b d8,0x4010000F; // move first 4 bits into LED
				
		move.l #6666666,d7 // Loop To Wait (Show Add 4MSB) 2 Seconds
LOOP1: 	SUBI.l #1,d7
		BNE LOOP1
	
		move.b #0,0x4010000F; // move first 4 bits into LED	
...
LOOP2: 	SUBI.l #1,d7
		...
		move.l #6666666,d7 // Loop To Wait (Show Next 4MSB) 2 Seconds
LOOP3: 	SUBI.l #1,d7
		BNE LOOP3
