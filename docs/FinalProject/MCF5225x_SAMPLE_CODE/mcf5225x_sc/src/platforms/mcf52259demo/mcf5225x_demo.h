/*
 * File:		m5225x_demo.h
 * Purpose:		M52259DEMO and TWR-MCF5225x board definitions and memory map information
 *
 * Notes:
 * 
...
#ifndef _M5225xDEMO_H
#define _M5225xDEMO_H
...
#define REF_CLK_MHZ         	8   /* PLL input clock */
