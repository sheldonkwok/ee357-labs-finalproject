...
int 
fec_mii_write(int, int, int, int);

int 
fec_mii_read(int, int, int, uint16*);
...
void
fec_set_address (int, const uint8*);

void
fec_reset (int);

void
fec_init (int, int, MII_DUPLEX, int, const uint8*);
...
int
fec_send (int , uint8*, uint8*, uint16 , NBUF*);
