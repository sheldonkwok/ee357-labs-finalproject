...
void init_lcd()
{
    ...
    MCF_GPIO_PTIPAR = 0
		| MCF_GPIO_PTIPAR_FEC_RXD3_GPIO         
		| MCF_GPIO_PTIPAR_FEC_RXD2_GPIO    
		| MCF_GPIO_PTIPAR_FEC_RXD1_GPIO       
		| MCF_GPIO_PTIPAR_FEC_RXD0_GPIO;
...
void grphSCL_ClrVal() 
{
    MCF_GPIO_PORTTI &= ~MCF_GPIO_PORTTI_PORTTI3;       
}
void grphSCL_SetVal() 
{
    MCF_GPIO_PORTTI |= MCF_GPIO_PORTTI_PORTTI3;       
...
void grphRS_ClrVal() 
{
	MCF_GPIO_PORTTI &= ~MCF_GPIO_PORTTI_PORTTI4;      
}
void  grphRS_SetVal() 
{
	MCF_GPIO_PORTTI |= MCF_GPIO_PORTTI_PORTTI4;      
...
void grphSI_ClrVal() 
{
	MCF_GPIO_PORTTI &= ~MCF_GPIO_PORTTI_PORTTI5;      
}
void grphSI_SetVal() 
{
	MCF_GPIO_PORTTI |= MCF_GPIO_PORTTI_PORTTI5;      
...
{
	MCF_GPIO_PORTTI &= ~MCF_GPIO_PORTTI_PORTTI6;      
}
