...
** ===================================================================
*/
#define ledGreen_GetVal() ( \
    (bool)((getReg8(PTJD) & 0x02))     /* Return port data */ \
  )
...
#define ledGreen_ClrVal() ( \
    (void)clrReg8Bits(PTJD, 0x02)      /* PTJD1=0x00 */ \
  )
...
#define ledGreen_SetVal() ( \
    (void)setReg8Bits(PTJD, 0x02)      /* PTJD1=0x01 */ \
  )
...
#define ledGreen_NegVal() ( \
    (void)invertReg8Bits(PTJD, 0x02)   /* PTJD1=invert */ \
  )
