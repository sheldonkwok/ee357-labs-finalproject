...
Sources/console_io_cf.obj: ../Sources/console_io_cf.c
	@echo 'Building file: $<'
	@echo 'Invoking: ColdFire Compiler'
	"C:\Program Files\Freescale\CW MCU v10.0\eclipse\../MCU/ColdFire_Tools/Command_Line_Tools/mwccmcf" @"Sources/console_io_cf.args" -o "Sources/console_io_cf.obj" "$<"
	"C:\Program Files\Freescale\CW MCU v10.0\eclipse\../MCU/ColdFire_Tools/Command_Line_Tools/mwccmcf" @"Sources/console_io_cf.args" -o "Sources/console_io_cf.obj" "$<" -MD -gccdep
	@echo 'Finished building: $<'
	@echo ' '
...
Sources/ee357_asm_lib.obj: ../Sources/ee357_asm_lib.s
	...
	"C:\Program Files\Freescale\CW MCU v10.0\eclipse\../MCU/ColdFire_Tools/Command_Line_Tools/mwasmmcf" @"Sources/ee357_asm_lib.args" -o "Sources/ee357_asm_lib.obj" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
Sources/main.obj: ../Sources/main.s
	@echo 'Building file: $<'
	@echo 'Invoking: ColdFire Assembler'
	"C:\Program Files\Freescale\CW MCU v10.0\eclipse\../MCU/ColdFire_Tools/Command_Line_Tools/mwasmmcf" @"Sources/main.args" -o "Sources/main.obj" "$<"
	@echo 'Finished building: $<'
	@echo ' '
