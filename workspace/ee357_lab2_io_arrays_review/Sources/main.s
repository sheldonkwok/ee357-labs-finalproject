...
main:		
		...
		movea.l #arr1,a1		// Setting Up arr1 Pointer
		move.l #0,d4 			// Setting Up Scaled Index to 0
		...
		move.b d1,0(a1,d4*1)	// Move 1st # to arr1[0]
		move.b d1,0x4010000F 	// Display 1st # - Move 1st # into PORTTC (LED)
		clr.l d1				// Clear D1
...
LOOP1:	move.b 0x40100044,d2	// Read 2nd # into D2
		...
		move.b 0(a1,d4*1),d1 	// Move 1st # to D1 - doing this as CMP is a longword operation
		CMP.l d2,d1				// Compare 1st # to 2nd # -> check if equal
		BEQ LOOP1				// Loop back if switch input is the same
		
		add.l #1,d4				// Increment Scaled Index to 1
		clr.l d1				// Clear D1
				
		// Store, Display 2nd Number
		move.b d2,0(a1,d4*1)	// Move 2nd # to arr1[1]
		move.b d2,0x4010000F	// Display 2nd # - Move 2nd # into PORTTC (LED)
		clr.l d2				// Clear D2
		
		// Calculate Average Number
		move.b -1(a1,d4*1),d1	// Move arr[0] to D1
		move.b 0(a1,d4*1),d2	// Move arr[1] to D2
		...
		add.l #1,d4				// Increment Scaled Index to 2
		move.b d1,0(a1,d4*1)	// Move Average # in D1 to arr1[2]
...
LOOP2: 	SUBI.l #1,D3
		...
		// Displaying Average #
AGAIN:	move.b 0(a1,d4*1),d1
		move.b d1,0x4010000F 	// Display Average # - arr[2] into PORTTC (LED)
