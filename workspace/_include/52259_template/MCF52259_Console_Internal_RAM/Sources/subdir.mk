...
Sources/main.obj: ../Sources/main.c
	@echo 'Building file: $<'
	@echo 'Invoking: ColdFire Compiler'
	"C:\Program Files (x86)\Freescale\CW MCU v10.0\eclipse\../MCU/ColdFire_Tools/Command_Line_Tools/mwccmcf" @"Sources/main.args" -o "Sources/main.obj" "$<"
	"C:\Program Files (x86)\Freescale\CW MCU v10.0\eclipse\../MCU/ColdFire_Tools/Command_Line_Tools/mwccmcf" @"Sources/main.args" -o "Sources/main.obj" "$<" -MD -gccdep
	@echo 'Finished building: $<'
	@echo ' '
